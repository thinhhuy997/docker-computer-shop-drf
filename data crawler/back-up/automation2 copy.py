...
def get_page_source(url):
    # url = 'https://tinhocngoisao.com/collections/cpu-intel'
    driver.get(url)
...
def extract_data(page_source):
    ...
    for link in links:
        ...
        for img_url in product_img_urls:
            product_img_url = img_url.get('src')
...
page_source = get_page_source('https://tinhocngoisao.com/collections/cpu-intel')

dict_data = extract_data(page_source)
